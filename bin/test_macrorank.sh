python main.py --model GClassifier  --dataset PlainClusterSet --checkp chekcp/GClassifier_[1]_0/last.pth --base_model EGNN_DENSE --label 1  --group 0 --egnn_layers 4 --pos_encode 4
